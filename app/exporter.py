...
def export_collection_zip(
    ...
    existing_metadata = (
        ...
        if preserve_existing_metadata and output_path.exists()
        else ExistingZipMetadata(None, None, {})
    )
    manifest_assignments = []

    with zipfile.ZipFile(output_path, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        if existing_metadata.modinfo_path and existing_metadata.modinfo_data:
            archive.writestr(
        ...
        if existing_metadata.preview_files:
